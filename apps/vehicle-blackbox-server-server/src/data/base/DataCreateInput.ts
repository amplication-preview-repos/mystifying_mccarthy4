...
class DataCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RecordCreateNestedManyWithoutDataItemsInput,
  })
  @ValidateNested()
  @Type(() => RecordCreateNestedManyWithoutDataItemsInput)
  @IsOptional()
  @Field(() => RecordCreateNestedManyWithoutDataItemsInput, {
    nullable: true,
  })
  records?: RecordCreateNestedManyWithoutDataItemsInput;
}

export { DataCreateInput as DataCreateInput };
