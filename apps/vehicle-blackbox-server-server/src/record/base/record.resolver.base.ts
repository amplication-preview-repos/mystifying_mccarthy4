...
export class RecordResolverBase {
  ...
  @graphql.ResolveField(() => Data, {
    nullable: true,
    name: "data",
  })
  async getData(@graphql.Parent() parent: Record): Promise<Data | null> {
    const result = await this.service.getData(parent.id);
  ...
  async getVehicle(@graphql.Parent() parent: Record): Promise<Vehicle | null> {
